...
class LyricsControllerTest < ActionController::TestCase
  ...
  test "should create lyric" do
    assert_difference('Lyric.count') do
      post :create, lyric: { composer: @lyric.composer, content: @lyric.content, lyricist: @lyric.lyricist, singer: @lyric.singer, title: @lyric.title }
    end
  ...
  test "should update lyric" do
    patch :update, id: @lyric, lyric: { composer: @lyric.composer, content: @lyric.content, lyricist: @lyric.lyricist, singer: @lyric.singer, title: @lyric.title }
    assert_redirected_to lyric_path(assigns(:lyric))
  end
